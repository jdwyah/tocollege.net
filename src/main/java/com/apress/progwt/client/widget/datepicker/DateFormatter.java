...
/*
 * DateFormatter, as its name suggests, is the object which formats the
 * date in a particular way. Currently, it supports 3 different formats:
 * MMDDYYYY, DDMMYYYY and DDMONYYYY
 */
import java.util.Date;

public class DateFormatter implements DateConstants {
    public final static DateFormat DATE_FORMAT_MMDDYYYY = DateFormat.DATE_FORMAT_MMDDYYYY;
    public final static DateFormat DATE_FORMAT_DDMMYYYY = DateFormat.DATE_FORMAT_DDMMYYYY;
    public final static DateFormat DATE_FORMAT_DDMONYYYY = DateFormat.DATE_FORMAT_DDMONYYYY;
     ...
     * 
     * @param Date (Date to be formatted) @param int (format in which to
     * format the date) @return String
     */
