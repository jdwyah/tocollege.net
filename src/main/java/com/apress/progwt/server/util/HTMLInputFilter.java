 ...
 * 
 * 
 * validateEntities() toCollegeExts()
 * 
...
public class HTMLInputFilter {
     ...
     * "unbalanced" angle brackets (e.g. "<b text </b>" becomes "<b>
     * text </b>"). If set to false, unbalanced angle brackets will be
     * html escaped.
     */
    ...
    /**
     * set of allowed html elements, along with allowed attributes for
     * each element *
     */
    ...
    /**
     * html elements which must always have separate opening and closing
     * tags (e.g. "<b></b>") *
     */
    ...
    private void toCollegeExts() {
        ...
        ArrayList<String> blockquote_atts = new ArrayList<String>();
        blockquote_atts.add("dir");
        blockquote_atts.add("style");
    ...
    protected String balanceHTML(String s) {
        if (ALWAYS_MAKE_TAGS) {
            ...
            // (we need to do a lookahead assertion so that the last
            // bracket can
    ...
    protected String processTag(String s) {
        ...
        if (m.find()) {
            ...
            // debug( "in a starting tag, name='" + name + "'; body='" +
            // body + "'; ending='" + ending + "'" );
            if (vAllowed.containsKey(name)) {
                String params = "";
    ...
    protected String validateEntities(String s) {
        ...
        // NOTE removed. Was screwing things up
        //
        // if (m.find()) {
